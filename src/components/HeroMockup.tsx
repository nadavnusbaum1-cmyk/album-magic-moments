...
const T = {
  he: {
    greeting: "היי שרה! מצאתי 47 תמונות שלך 🎉",
    download: "הורדת הכל",
    steps: [
      { t: "סריקת QR", d: "סורקים את הקוד באירוע" },
      { t: "שליחת סלפי", d: "מורי לומדת איך אתם נראים" },
      { t: "מקבלים את התמונות", d: "כל התמונות שלכם, מיד" },
    ],
  },
  en: {
